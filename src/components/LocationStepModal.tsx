      ...
      <div className="fixed inset-0 z-50 flex items-end justify-center bg-slate-900/40 dark:bg-black/60 backdrop-blur-sm sm:items-center sm:p-4">
        ...
        >
          ...
          <div className="p-4 space-y-4">
            <div className="flex items-start gap-2.5 bg-emerald-50/60 dark:bg-emerald-900/20 p-3 rounded-xl border border-emerald-100/50 dark:border-emerald-800/30">
            ...
            <div className="pt-2 border-t border-slate-200 dark:border-slate-800 space-y-2">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  type="button"
                  onClick={onClose}
                  className="flex-1 h-10 rounded-xl border border-slate-300 dark:border-slate-700 text-xs font-semibold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors flex items-center justify-center gap-1.5"
                >
